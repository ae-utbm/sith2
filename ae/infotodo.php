...
if (isset ($_REQUEST['action']) && $_REQUEST['action'] != 'commit' && $_REQUEST['action'] != 'stop'
  && $_REQUEST['action'] != 'done' && $_REQUEST['action'] != 'accord') {
    ...
    $frm->add_text_field ('desc', 'Description', $todo->desc,false,false,false,$util_reporter->load_by_id ($todo->id_user_reporter) === $site->user || $site->user->is_in_group("root")? true : false);
