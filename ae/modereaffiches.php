...
require_once($topdir . "include/entities/affiches.inc.php");
    ...
    ($_REQUEST['action'] == "edit"))
{
  ...
  /* dates */
  $frm->add_datetime_field("aff_deb","Date et heure de d&eacute;but");
  $frm->add_datetime_field("aff_fin","Date et heure de fin");
