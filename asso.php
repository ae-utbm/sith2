...
else if ( isset($_REQUEST["id_asso"]) )
{
  ...
  else
  {
	...
	{
		$path = 	classlink($asso_parent)." / ".$path;
		$asso_parent->load_by_id($asso_parent->id_parent);	
	}
	
	$path = "<a href=\"asso.php\">Associations</a> / ".$path;
    ...
    while ( $row = $req->get_row() )
    {
      ...
      {
        $gal->add_item(
          "<a href=\"asso.php?id_asso=".$row['id_asso']."\">&nbsp;<img src=\"images/icons128/asso.png\" alt=\"\" class=\"nope\" />&nbsp;</a>", 
