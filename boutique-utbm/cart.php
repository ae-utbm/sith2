...
require_once("comptoir/include/produit.inc.php");
require_once("comptoir/include/venteproduit.inc.php");
...
$cts->add(new tabshead(array(array("boutique","index.php","Boutique"),array("pannier","cart.php","Pannier"),array("","suivi.php","Commandes")),"section"));
