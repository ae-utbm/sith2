...
class facture_pdf extends FPDF
{
  ...
  function print_total()
  {
    ...
    /* total */
    $this->SetFont('Arial','B',14);
    $this->Cell(150,10,utf8_decode("Total à payer : "), "", 0, "R");
  ...
  function print_mentions_legales()
  {
    ...
    if($this->ht)
    {
      $this->Cell(150,10,utf8_decode("N°SIRET : 199 003 567 000 13"), "T", 1, "");
      $this->Cell(150,10,utf8_decode("TVA intracommunautaire : FR 60 199 003 567"), "0", 0, "");
    }
    else
