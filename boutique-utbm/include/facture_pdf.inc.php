...
class facture_pdf extends FPDF
{
  ...
  function print_mentions_legales()
  {
    ...
    else
    {
      ...
      {
        $this->Ln(10);
        $this->Cell(200,10,utf8_decode("Service : ".$this->factured_infos['name']), "RTL", 0, "");
        $this->Ln();
        $this->Cell(200,10,utf8_decode("Centre de coût : ".$this->factured_infos['srv_centre_cout']), "RL", 0, "");
        $this->Ln();
        if(isset($this->factured_infos['srv_eopt']))
        {
          $this->Cell(200,10,utf8_decode("EOPT : ".$this->factured_infos['srv_eopt']), "RL", 0, "");
          $this->Ln();
        }
        $this->Cell(200,10,utf8_decode("Contact : ".$this->factured_infos['srv_contact']), "RL", 0, "");
        $this->Ln();
        $this->Cell(200,10,utf8_decode("Objectif : ".$this->factured_infos['srv_obj']), "RLB", 0, "");
      }
      $this->Ln(10);
