...
class facture_pdf extends FPDF
{
  ...
  function print_total()
  {
    ...
    /* total */
    $this->SetFont('Arial','B',14);
    $this->Cell(121.5,10,utf8_decode("Total à payer : "), "T", 0, "R");
    ...
    if($this->ht)
    {
      ...
      $this->Cell(121.5,10,utf8_decode("Dont TVA : "), "0", 0, "R");
  ...
  function print_mentions_legales()
  {
    ...
    else
    {
         ...
         && isset($this->factured_infos['srv_centre_cout']))
      {
        ...
        $this->Cell(168.5,10,utf8_decode($this->factured_infos['name']), "RT", 0, "");
        $this->Ln();
        $this->Cell(21.5,10,utf8_decode("Centre de coût"), "TL", 0, "");
        $this->Cell(168.5,10,utf8_decode($this->factured_infos['srv_centre_cout']), "TR", 0, "");
        $this->Ln();
        if(isset($this->factured_infos['srv_eopt']))
        {
          $this->Cell(21.5,10,utf8_decode("EOTP"), "LT", 0, "");
          $this->Cell(168.5,10,utf8_decode($this->factured_infos['srv_eopt']), "TR", 0, "");
          $this->Ln();
        }
        $this->Cell(21.5,10,utf8_decode("Contact"), "LT", 0, "");
        $this->Cell(168.5,10,utf8_decode($this->factured_infos['srv_contact']), "TR", 0, "");
        $this->Ln();
        $this->Cell(21.5,10,utf8_decode("Objectif"), "LBT", 0, "");
        $this->Cell(168.5,10,utf8_decode($this->factured_infos['srv_obj']), "TRB", 0, "");
      }
      $this->Ln(10);
