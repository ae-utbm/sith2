...
class facture_pdf extends FPDF
{
  ...
  function Header ()
  {
    ...
    $this->Ln(10);
    /* date */
    $this->Cell(210,12, 'Du '.$this->date_facturation,0,0,'C');
    $this->Ln(20);
    $this->Ln(0.5);
  ...
  function print_total()
  {
    ...
    /* total */
    $this->SetFont('Arial','B',14);
    $this->Cell(120,10,utf8_decode("Total à payer : "), "T", 0, "R");
    ...
    if($this->ht)
    {
      ...
      $this->Cell(120,10,utf8_decode("Dont TVA : "), "0", 0, "R");
  ...
  function print_mentions_legales()
  {
    ...
    else
    {
      ...
      {
        $this->Ln(10);
        $this->Cell(20,10,utf8_decode("Service"), "TL", 0, "");
        $this->Cell(180,10,utf8_decode(": ".$this->factured_infos['name']), "RT", 0, "");
        $this->Ln();
        $this->Cell(20,10,utf8_decode("Centre de coût"), "L", 0, "");
        $this->Cell(180,10,utf8_decode(": ".$this->factured_infos['srv_centre_cout']), "R", 0, "");
        $this->Ln();
        if(isset($this->factured_infos['srv_eopt']))
        {
          $this->Cell(20,10,utf8_decode("EOTP"), "L", 0, "");
          $this->Cell(180,10,utf8_decode(": ".$this->factured_infos['srv_eopt']), "R", 0, "");
          $this->Ln();
        }
        $this->Cell(20,10,utf8_decode("Contact"), "L", 0, "");
        $this->Cell(180,10,utf8_decode(": ".$this->factured_infos['srv_contact']), "R", 0, "");
        $this->Ln();
        $this->Cell(20,10,utf8_decode("Objectif"), "LB", 0, "");
        $this->Cell(180,10,utf8_decode(": ".$this->factured_infos['srv_obj']), "RB", 0, "");
      }
      $this->Ln(10);
      $this->Cell(120,10,utf8_decode("TVA non applicable, article 293B du CGI"), "T", 0, "");
    }
    //marge
    $this->Ln(10);
  }
