...
class facture_pdf extends FPDF
{
  ...
  function print_total()
  {
    ...
    /* total */
    $this->SetFont('Arial','B',14);
    $this->Cell(121,10,utf8_decode("Total à payer : "), "T", 0, "R");
    ...
    if($this->ht)
    {
      ...
      $this->Cell(121,10,utf8_decode("Dont TVA : "), "0", 0, "R");
