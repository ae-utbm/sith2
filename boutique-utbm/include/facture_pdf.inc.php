  ...
  function print_mentions_legales()
  {
    ...
    else
    {
         ...
         && isset($this->factured_infos['srv_centre_cout']))
      {
        ...
        $this->Cell(168.5,10,utf8_decode(": ".$this->factured_infos['srv_centre_cout']), "R", 0, "");
        $this->Ln();
        if(isset($this->factured_infos['srv_eopt']))
        {
          $this->Cell(21.5,10,utf8_decode("EOTP"), "L", 0, "");
          $this->Cell(168.5,10,utf8_decode(": ".$this->factured_infos['srv_eopt']), "R", 0, "");
          $this->Ln();
        }
        $this->Cell(21.5,10,utf8_decode("Contact"), "L", 0, "");
        $this->Cell(168.5,10,utf8_decode(": ".$this->factured_infos['srv_contact']), "R", 0, "");
        $this->Ln();
        $this->Cell(21.5,10,utf8_decode("Objectif"), "LB", 0, "");
        $this->Cell(168.5,10,utf8_decode(": ".$this->factured_infos['srv_obj']), "RB", 0, "");
      }
      $this->Ln(10);
