...
if ( isset($_REQUEST["mode"]) )
{
  ...
  else
  {
    ...
    $list->add("<a href=\"http://ae.utbm.fr/article.php?name=docs:inscription\">Documentation : Inscription</a>");
    $list->add("<a href=\"http://ae.utbm.fr/article.php?name=docs:inscription\">Documentation : Inscription : Questions et problèmes fréquents</a>");
    $list->add("<a href=\"http://ae.utbm.fr/article.php?name=docs:index\">Documentation</a>");
    $cts->add($list,true);
