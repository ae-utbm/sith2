...
class sitecompta extends site
{
	...
	{
		$req = new requete($this->db,"SELECT `id_opclb`, `type_mouvement`, `libelle_opclb`  FROM `cpta_op_clb` WHERE `id_asso`='".intval($id_asso)."'".($mvt?" AND type_mouvement=$mvt":"")." ORDER BY `type_mouvement`,`libelle_opclb`");
