...
class productinfo extends stdcontents
{
  ...
  function productinfo ( $product, $barman=false, $sales=false)
  {
    ...
    $this->buffer .= "<a href=\"#\" title=\"Ajouter 1 ".$product->nom." au panier\" onclick=\"return addToCart('$product->code_barre', '".addslashes($product->nom)."', $prix, ".($product->plateau && !$barman).";\">"."\n";
