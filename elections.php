		...
		else
		{
			...
			while ( list($id_poste,$nom_poste,$blanc,$total) = $sql->get_row() )
			{
				...
				while ( $srow = $sql2->get_row() )
				{
					...
					if ( file_exists($topdir."images/matmatronch/".$srow['id_utilisateur'].".identity.jpg") )
						$cdts[$id_liste] .= "<img src=\"/images/matmatronch/".$srow['id_utilisateur'].".identity.jpg\" alt=\"\" onclick=\"document.getElementById('$idradio').checked = true;\" /><br/>\n";
					else
						$cdts[$id_liste] .= "<img src=\"/images/matmatronch/na.gif"."\" alt=\"\" onclick=\"document.getElementById('$idradio').checked = true;\" /><br/>\n";
