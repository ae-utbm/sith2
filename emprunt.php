...
if ( $emp->id > 0 )
{
	...
	$cts = new contents("Reservation/Emprunt n°".$emp->id);
...
if ( $_REQUEST["page"] == "retour" && $site->user->is_in_group("gestion_ae") )
{
	...
	$cts = new contents("Retour matériel");
...
if ( $_REQUEST["page"] == "retrait" && $site->user->is_in_group("gestion_ae") )
{
	...
	$cts = new contents("Emprunt immediat");
...
$site->start_page("services","Reserver du matériel");
...
$cts = new contents("Reserver du matériel");
if ( $Error )
	$frm->error($Error);
