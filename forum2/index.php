...
{
  $site->add_contents(new error("Vous n'avez pas respecté la charte de publication, votre présence n'est désormais plus souhaité.",false));
  $site->end_page();
  exit();
}
...
if ( $site->user->is_valid() )
  $cts->buffer = "<p class=\"center\">Connecté en tant que ".$site->user->alias." - <a href=\"../user.php?page=edit\">Mon profil</a> - <a href=\"search.php?page=unread\">Messages non lus</a></p>";
else
