...
if ( $site->user->id < 1 || !$site->user->ae )
{
...
if (file_exists("/var/www/ae/www/ae2/images/matmatronch/".$user->id.".identity.i.jpg"))
{
  $fiche->puts("<p align=\"center\"><img src=\"/images/matmatronch/".$user->id.".identity.i.jpg\" /></p>");
}
else if (file_exists("/var/www/ae/www/ae2/images/matmatronch/".$user->id.".identity.jpg"))
{
  $src =  "/var/www/ae/www/ae2/images/matmatronch/".$user->id.".identity.jpg";
  $dest = "/var/www/ae/www/ae2/images/matmatronch/".$user->id.".identity.i.jpg";
  print_r(exec("/usr/share/php5/exec/convert $src -thumbnail 64x64 -quality 95 $dest"));
      
  $fiche->puts("<p align=\"center\"><img src=\"/images/matmatronch/".$user->id.".identity.i.jpg\" /></p>");
}
else if (file_exists("/var/www/ae/www/ae2/images/matmatronch/".$user->id.".i.jpg"))
{
  $fiche->puts("<p align=\"center\"><img src=\"/images/matmatronch/".$user->id.".i.jpg\" /></p>");
}
else if (file_exists("/var/www/ae/www/ae2/images/matmatronch/".$user->id.".jpg"))
{
  $src =  "/var/www/ae/www/ae2/images/matmatronch/".$user->id.".jpg";
  $dest = "/var/www/ae/www/ae2/images/matmatronch/".$user->id.".i.jpg";
  print_r(exec("/usr/share/php5/exec/convert $src -thumbnail 64x64 -quality 95 $dest"));
...
if ( $user->tel_maison )
  $fiche->puts("Fixe: <a href=\"tel:" . htmlentities($user->tel_maison,ENT_COMPAT,"UTF-8")  ."\" telbook=\"".htmlentities($user->prenom." ".$user->nom,ENT_COMPAT,"UTF-8")."\" accesskey=\"1\">&#59106; " . htmlentities($user->tel_maison,ENT_COMPAT,"UTF-8")  ."</a><br />");  
if ( $user->tel_portable )
  $fiche->puts("Portable: <a href=\"tel:" . htmlentities($user->tel_portable,ENT_COMPAT,"UTF-8") ."\" telbook=\"".htmlentities($user->prenom." ".$user->nom,ENT_COMPAT,"UTF-8")."\" accesskey=\"2\">&#59107; " . htmlentities($user->tel_portable,ENT_COMPAT,"UTF-8") ."</a><br />");
