...
class calendar extends stdcontents
{
	...
	*/
	function html_render ()
	{
		...
		* mois courant a partir du timestamp */
		...
		$this->buffer .= "<tr>\n";
		$this->buffer .= "<td class=\"month\"><a href=\"?caldate=$prevdate\" onclick=\"return !openInContents('sbox_body_calendrier','".$tgtopdir."gateway.php','class=calendar&amp;caldate=$prevdate&amp;topdir=$tgtopdir');\">&laquo;</a></td>\n";
		$this->buffer .= "<td class=\"month\" colspan=\"5\">" . $this->months[$month-1] . " " . $year . "</td>\n";
		$this->buffer .= "<td class=\"month\"><a href=\"?caldate=$nextdate\" onclick=\"return !openInContents('sbox_body_calendrier','".$tgtopdir."gateway.php','class=calendar&amp;caldate=$nextdate&amp;topdir=$tgtopdir');\">&raquo;</a></td>\n";
		$this->buffer .= "</tr>\n";
	...
	*/
	function day ($year, $month, $day)
	{
		...
		if($event->lines > 0)
		{
			$this->buffer .= "<td class=\"$style\"$js><a href=\"" . $topdir . "events.php?day=" . $date . "\">" . $day . "</a></td>";
		}
		else
		{
