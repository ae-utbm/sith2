...
class basedb
{
	...
	/**
	 * Détermine si l'utilisateur a le droit spécifié sur l'élèment
	 * @param $user Instance de utilisateur
	...
	/** 
	 * Fait hériter les droits depuis un autre élèment.
	 ...
	 * @param $user Instance de l'utilisateur qui fait la modification (sui deviendra p^ropiètaire si aucun n'est définit)
	 * @param $rigths Droits
	 * @param $id_group Id du groupe propriètaire
