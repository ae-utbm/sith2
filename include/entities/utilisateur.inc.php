...
http://ae.utbm.fr". $GLOBALS["wwwtopdir"]."majprofil.php?id_utilisateur=" . $this->id . "&hash=" . $this->hash . "
  ...
  function send_majprofil_email ( &$site, $email=null )
  {
    ...
    if ( $this->hash != "valid" )
      ...
      $body = "Bonjour,\n".
        ...
        "http://ae.utbm.fr". $GLOBALS["wwwtopdir"]."majprofil.php?id_utilisateur=" . $this->id . "&token=" . $site->create_token_for_user($this->id) . "\n".
        "\n".
        "L'équipe info AE";
...
http://ae.utbm.fr". $GLOBALS["wwwtopdir"]."forum2/rss.php?id_utilisateur=".$this->id."&serviceident=$uid
