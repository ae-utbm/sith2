  ...
  function cycle ( $detectcollision=false )
  {
    ...
    new requete($this->dbrw,"UPDATE 	galaxy_star a, 
					(SELECT a.id_star AS id_a, b.id_star AS id_b, 
						SUM(sum_tense_star*(a.x_star - b.x_star)/POW(SQRT(POW(a.x_star - b.x_star,2) + POW(a.y_star - b.y_star, 2)),5)) AS ax, 
						SUM(sum_tense_star*(a.y_star - b.y_star)/POW(SQRT(POW(a.x_star - b.x_star,2) + POW(a.y_star - b.y_star, 2)),5)) AS ay 
