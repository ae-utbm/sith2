...
/*    if ( $siteae )
  ...
  function get_comptoir()
  {
    ...
    while ( list($id,$nom) = $req->get_row() )
    {
      ...
      $list.="<a href=\"".$topdir."comptoir/activity.php?id_comptoir=$id\"><img src=\"".$topdir."images/leds/".$led."2led.png\" class=\"icon\" alt=\"".htmlentities($descled,ENT_NOQUOTES,"UTF-8")."\" title=\"".htmlentities($descled,ENT_NOQUOTES,"UTF-8")."\" /> $nom</a>";
      if($i<$req->lines)
        $list.='<br />';
    }
