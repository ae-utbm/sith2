...
else if(isset($_REQUEST['view']) && $_REQUEST['view'] == "clients")
{
	...
	$cts->add( new sqltable("list_clients", "Clients de AE JobEtu", $sql, "admin.php?view=clients", "id_utilisateur", array("id_utilisateur" => "ID", "nom_utilisateur" => "Nom"), array("mail" => "Envoyer un mail", "delete" => "Désactiver compte", "edit" => "Editer préférences"), array("mailto" => "Envoyer un mail", "del_account" => "Désactiver compte")), true );
}
