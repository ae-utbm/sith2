...
EOF;
  ...
  if($error)
    $frm->error($error);
  $frm->add_checkbox("accept_cgu", "Je reconnais avoir lu et accepter les <a href=\"http://ae.utbm.fr". $GLOBALS["wwwtopdir"]."article.php?name=docs:jobetu:cgu\">CGU d'AE Job Etu</a>");
