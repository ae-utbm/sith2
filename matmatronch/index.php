...
$list->add("<a href=\"javascript:window.external.AddSearchProvider('http://ae.utbm.fr". $GLOBALS["wwwtopdir"]."matmatronch/matmatronch.xml');\">Extension Firefox</a>");
$list->add("La version mobile : <a href=\"http://ae.utbm.fr". $GLOBALS["wwwtopdir"]."m/\">http://ae.utbm.fr/m/</a> <a href=\"".$topdir."iinfo.php\">Informations</a>");
$info->add($list,true);
