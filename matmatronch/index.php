...
$list->add("<a href=\"".$topdir."e-boutic/?id_typeprod=25\">Acheter la version papier</a>");
$list->add("<a href=\"javascript:window.external.AddSearchProvider('".$topdir."matmatronch/matmatronch.xml');return false;\">Extension Firefox</a>");
...
$list->add("<a href=\"".$topdir."article.php?name=docs:inscription\">Inscription</a>");
$list->add("<a href=\"".$topdir."article.php?name=docs:connexion\">Connexion</a>");
$info->add($list,true);
