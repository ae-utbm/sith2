...
else
{
  ...
  $pl = new weekplanning ("Planning", $site->db, $sql, "id_gap", "start_gap", "end_gap", "texte", "index.php?action=searchpl", "index.php?action=affich&id_planning=".$_REQUEST['id_salle'], "", PL_LUNDI, true);
}
