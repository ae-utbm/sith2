  ...
  * @param $rev Revision du fichier
  ...
  function generate_thumbs()
  {
    if ( ereg("image/(.*)",$this->mime_type) )
    {
      ...
      exec(escapeshellcmd("/usr/bin/convert ".$this->get_real_filename()." -thumbnail 128x128 -quality 95 $f"));
      ...
      exec(escapeshellcmd("/usr/bin/convert ".$this->get_real_filename()." -thumbnail 500x1000 -quality 95 $f"));
    }
  }
