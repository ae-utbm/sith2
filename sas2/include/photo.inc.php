...
class photo extends basedb
{
   ...
   */
  function add_photo ( $tmp_filename, $id_catph, $commentaire="", $id_utilisateur_photographe=null, $nobody=false,$meta_id_asso=NULL)
  {
    $this->date_prise_vue=null;
    ...
    exec("/usr/share/php5/exec/convert $tmp_filename -thumbnail 1600x1600 -quality 80 $dest_hd");
  ...
  function update_photo ( $date_prise_vue, $commentaire="", $id_utilisateur_photographe=null, $meta_id_asso=NULL)
  {
