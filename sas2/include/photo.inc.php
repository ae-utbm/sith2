...
class photo extends basedb
{
                      ...
                      , $id_licence=null)
  {
    ...
    exec(escapeshellcmd("/usr/bin/convert $tmp_filename -thumbnail 140x105 -quality 95 $dest_vgt"));
    if($w < 680 && $h < 510)
      exec(escapeshellcmd("/usr/bin/convert $tmp_filename -thumbnail ".$w."x".$h." -quality 80 $dest_dip"));
    else
      exec(escapeshellcmd("/usr/bin/convert $tmp_filename -thumbnail 680x510 -quality 80 $dest_dip"));
    if($w < 2400 && $h < 2400)
      exec(escapeshellcmd("/usr/bin/convert $tmp_filename -thumbnail ".$w."x".$h." -quality 80 $dest_hd"));
    else
      exec(escapeshellcmd("/usr/bin/convert $tmp_filename -thumbnail 2400x2400 -quality 80 $dest_hd"));
                         ...
                         , $id_licence=null)
  {
    ...
    exec(escapeshellcmd("/usr/bin/convert $tmp_photo_filename -thumbnail 140x105 -quality 95 $dest_vgt"));
    exec(escapeshellcmd("/usr/bin/convert $tmp_photo_filename -thumbnail 680x510 -quality 80 $dest_dip"));
    exec(escapeshellcmd("/usr/bin/convert $tmp_photo_filename -thumbnail 2400x2400 -quality 80 $dest_hd"));
  ...
  function rotate ( $degrees=90 )
  {
    ...
    exec(escapeshellcmd("/usr/bin/convert $src_hd -rotate ".intval($degrees)." -quality 80 $src_hd"));
    exec(escapeshellcmd("/usr/bin/convert $src_hd -thumbnail 140x105 -quality 95 $dest_vgt"));
    exec(escapeshellcmd("/usr/bin/convert $src_hd -thumbnail 680x510 -quality 80 $dest_dip"));
  }
  ...
  function flip($flip=1)
  {
    ...
    if($flip==1)//horizontal
      exec(escapeshellcmd("/usr/bin/convert $src_hd -flop ".intval($degrees)." -quality 80 $src_hd"));
    if($flip==2)//vertical
      exec(escapeshellcmd("/usr/bin/convert $src_hd -flip ".intval($degrees)." -quality 80 $src_hd"));
    exec(escapeshellcmd("/usr/bin/convert $src_hd -thumbnail 140x105 -quality 95 $dest_vgt"));
    exec(escapeshellcmd("/usr/bin/convert $src_hd -thumbnail 680x510 -quality 80 $dest_dip"));
  }
