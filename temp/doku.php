...
You can also use an image to link to another internal or external page by combining the syntax for links and [[#images_and_other_files|images]] (see below) like this:
  ...
  [[http://www.php.net|{{http://ae.utbm.fr/var/img/logos/ae.icon.png}}]]
...
{{dfile://729|left }}
{{ dfile://729|center }}
{{ dfile://729?400x200|center and resize }}
[[dfile://729|{{dfile://729?400x200}}]]
...
Real size:                        {{http://ae.utbm.fr/var/img/logos/ae.icon.png}}

Resize to given width:            {{http://ae.utbm.fr/var/img/logos/ae.icon.png?50}}

Resize to given width and height: {{http://ae.utbm.fr/var/img/logos/ae.icon.png?200x50}}
...
{{ http://ae.utbm.fr/var/img/logos/ae.icon.png}}
...
{{ http://ae.utbm.fr/var/img/logos/ae.icon.png |This is the caption}}
...
| Row 1 Col 1    | Row 1 Col 2     | {{http://ae.utbm.fr/var/img/logos/ae.icon.png?200x50}} |
...
$cts = new contents("dokuwiki tests");

$cts->puts(doku2xhtml($text));

$site->start_page("forum","AE - Recherche et Développement");
