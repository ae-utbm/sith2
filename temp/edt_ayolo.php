...
{
  $edt_img = new edt_img("Ayolo", $_SESSION['edt']);
  $edt_img->generate ();
}

$ct = new contents("Emploi du temps");
$ct->add_paragraph("<center><img src=\"".$topdir."temp/edt_ayolo.php?generate=1\" alt=\"edt\" /></center>");

unset($_SESSION['edt']);
$string = file_get_contents($topdir. "temp/ayolo.txt");
