...
if ( $_REQUEST["page"] == "edit" && $can_edit )
{
  ...
  if ( !isset($_REQUEST["see"]) || empty($_REQUEST["see"]) )
  {
    ...
    $subfrm1->add_entity_smartselect ("id_ville","Ville (France)", $ville,true,false,array('id_pays'=>'id_pays_id'),true);
    ...
    if ( $user->etudiant || $user->ancien_etudiant )
    {
      ...
      $subfrm3->add_entity_smartselect ("id_ville_parents","Ville parents (France)", $ville_parents,true,false,array('id_pays'=>'id_pays_parents_id'),true);
