    ...
    || (isset($_id_uv)))
{
  ...
  $tabs = array(array("", $topdir ."uvs/uvs.php?id_uv=".$uv->id, "Informations générales"),
		array("infosetu", $topdir ."uvs/uvs.php?view=infosetu&id_uv=".$uv->id, "Historique de suivi"),
		array("commentaires", $topdir ."uvs/uvs.php?view=commentaires&id_uv=".$uv->id, "Commentaires"),
